...
public class SyncGetRating {
	...
	//Contractor
	public SyncGetRating(Context activity, String guid, String hamyarcode) {
	...
	private class AsyncCallWS extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
        	if(result == null)
        	{
	            if(WsResponse.toString().compareTo("ERROR") == 0)
	            {
