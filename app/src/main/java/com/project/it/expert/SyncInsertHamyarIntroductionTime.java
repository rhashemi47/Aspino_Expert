...
public class SyncInsertHamyarIntroductionTime {
	...
	//Contractor
	public SyncInsertHamyarIntroductionTime(Activity activity, String hamyarcode) {
    ...
    {
		SyncGettHamyarIntroductionTime syncGettHamyarIntroductionTime=new SyncGettHamyarIntroductionTime(activity,hamyarcode);
		syncGettHamyarIntroductionTime.AsyncExecute();
	}
}
