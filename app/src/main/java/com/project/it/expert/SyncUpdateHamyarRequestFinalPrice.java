...
public class SyncUpdateHamyarRequestFinalPrice {
	...
	//Contractor
	public SyncUpdateHamyarRequestFinalPrice(Activity activity, String RequestCode, String Price) {
	...
	private class AsyncCallWS extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
        	...
        	try
        	{
        		CallWsMethod("UpdateHamyarRequestFinalPrice");
        	}
	    	catch (Exception e) {
	...
	public void CallWsMethod(String METHOD_NAME) {
		...
		//Set Value
		RequestCodePI.setValue(this.RequestCode);
		//Set dataType
    ...
    {
		LoadActivity(MainMenu.class,"guid", "","hamyarcode","");
	}
